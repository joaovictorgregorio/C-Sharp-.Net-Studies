...
namespace PaymentThree
{
    ...
    {
        // Garbage Collector = coletor de lixo. Facilita a alocação e exclusão dos objetos da memória, atua de forma independente. Microsoft recomenda deixar ele trabalhando, sem modificações feitas por nós. OBS:  Comando para chamada GC.Collector.
        public Pagamento()
        {
